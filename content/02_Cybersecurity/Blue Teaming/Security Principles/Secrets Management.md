...
- **Talisman** – [Pre-commit](https://github.com/pre-commit/pre-commit-hooks?tab=readme-ov-file#readme) hook that prevents sensitive files or secrets from being committed.
